...
## Load dataset -------------------------------------------------------------------------------------------------------
fdata <- read.table("UnivariateDensityEstimation.dat",header = TRUE, sep = "")
...
lines(xgrid,dgrid.norm,col="red")  #Plot fitted on top
